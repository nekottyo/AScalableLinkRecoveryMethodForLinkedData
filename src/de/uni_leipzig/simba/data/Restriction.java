...
public class Restriction implements Serializable
{
	...
	{		
		...
		if(tokens.length<2||tokens.length>3) throw new IllegalArgumentException("parameter s has to consist of exactly two or three parts separated by space characters.");
